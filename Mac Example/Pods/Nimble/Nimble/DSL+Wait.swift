...
internal class NMBWait: NSObject {
    ...
    internal class func until(file: String = __FILE__, line: UInt = __LINE__, action: (() -> Void) -> Void) {
...
public func waitUntil(timeout timeout: NSTimeInterval = 1, file: String = __FILE__, line: UInt = __LINE__, action: (() -> Void) -> Void) {
