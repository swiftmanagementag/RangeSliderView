 ...
 */
public func sharedExamples(name: String, closure: () -> Void) {
 ...
 */
public func describe(description: String, flags: FilterFlags = [:], closure: () -> Void) {
 ...
 */
public func context(description: String, flags: FilterFlags = [:], closure: () -> Void) {
 ...
 */
public func it(description: String, flags: FilterFlags = [:], file: String = __FILE__, line: UInt = __LINE__, closure: () -> Void) {
 ...
 */
public func pending(description: String, closure: () -> Void) {
 ...
 */
public func xdescribe(description: String, flags: FilterFlags, closure: () -> Void) {
...
/**
 ...
 This disables all examples within the closure.
 */
public func xcontext(description: String, flags: FilterFlags, closure: () -> Void) {
 ...
 */
public func xit(description: String, flags: FilterFlags = [:], file: String = __FILE__, line: UInt = __LINE__, closure: () -> Void) {
 ...
 */
public func fdescribe(description: String, flags: FilterFlags = [:], closure: () -> Void) {
 ...
 */
public func fcontext(description: String, flags: FilterFlags = [:], closure: () -> Void) {
...
/**
 ...
 If any examples in the test suite are focused, only those examples are executed.
 */
public func fit(description: String, flags: FilterFlags = [:], file: String = __FILE__, line: UInt = __LINE__, closure: () -> Void) {
