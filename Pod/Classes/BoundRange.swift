...
struct BoundRange {
    ...
    func boundByApplyingInset(_ value: CGFloat) -> BoundRange {
        return BoundRange(start: start + value, end: end - value)
    }
}
 ...
 */
func locationInRange(range: Range<Int>, viewWidth: CGFloat, xLocationInView: CGFloat, itemWidth: CGFloat) -> CGFloat {
